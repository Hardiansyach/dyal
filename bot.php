					                    ...
					                    'columns' => array(
					                    	array(
					                    	    ...
					                    	    'actions' => array(
					                    	        array(
					                    	            'type' => 'message', // 類型 (訊息)
					                    	            'label' =>'Isi Pulsa / Kuota', // 標籤 2
					                    	            'text' => '/isi-pulsa-kuota' // 用戶發送文字
					                    	        ),
					                    	        array(
					                    	            'type' => 'message', // 類型 (訊息)
					                    	            'label' =>'Isi Saldo', // 標籤 2
					                    	            'text' => '/isi-saldo' // 用戶發送文字
					                    	        ),
					                    	        array(
					                    	            'type' => 'message', // 類型 (訊息)
					                    	            'label' =>'Cek Harga', // 標籤 2
					                    	            'text' => '/cek-harga' // 用戶發送文字
					                    	        ),
					                    	    )
					                    	),
					                       array(
					                    	    ...
					                    	    'actions' => array(
					                    	        ...
					                    	        array(
					                    	            'type' => 'message', // 類型 (訊息)
					                    	            'label' => 'Daftarkan Agen', // 標籤 2
					                    	            'text' => '/daftar-agen' // 用戶發送文字
					                    	        ),
					                    	        array(
					                    	            'type' => 'message', // 類型 (訊息)
					                    	            'label' => 'Tukar Komisi', // 標籤 2
					                    	            'text' => '/tukar-komisi' // 用戶發送文字
					                    	        )
					                    	    )
					                    	),
					                          array(
					                       	    ...
					                       	    'actions' => array(
					                       	    	array(
					                       	    	    'type' => 'message', // 類型 (訊息)
					                       	    	    'label' => 'Cek Status Transaksi', // 標籤 2
					                       	    	    'text' => '/komplain-transaksi' // 用戶發送文字
					                       	    	),
					                       	        array(
					                       	            'type' => 'message', // 類型 (訊息)
					                       	        ...
					                       	        array(
					                       	            'type' => 'message', // 類型 (訊息)
					                       	            'label' => 'Pararel Nomor', // 標籤 2
					                       	            'text' => '/pararel-nomor' // 用戶發送文字
					                       	        )
					                       	    )
					                       	),
					                       array(
