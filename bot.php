    ...
    function bacaURL($url){
      ...
      $sumber =  bacaURL('http://propana.otoreport.com/harga.js.php?prd='.$pesan_datang.'&up=200');
      ...
      $DOM = new DOMDocument();
      $DOM->loadHTML($ambil_kata_lagi[1]);
                    ...
                    array(
                        ...
                        'template' => array(
                            ...
                            'columns' => array(
                                array(
                                    'thumbnailImageUrl' => 'https://api.reh.tw/line/bot/example/assets/images/example.jpg', // 圖片網址 <不一定需要>
                                    'title' => $aDataTableHeaderHTML[3], // 標題 1 <不一定需要>
                                    'text' => "contoh", // 文字 1
                                    'actions' => array(
                                        array(
                                            'type' => 'message', // 類型 (訊息)
                                            'label' => $aDataTableHeaderHTML[1], // 標籤 2
                                            'text' => "contoh" // 用戶發送文字
                                        )
                                    )
                                )
